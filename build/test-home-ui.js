...
## Action items [01:00]
- Ninfa: update the changelog before the rollout
`
});
...
meeting(`${monday}_1000`, {
  ...
  'participants.txt': 'Chuck, Ninfa, Carlos',
...
app.whenReady().then(async () => {
  ...
  check('las tareas nuevas traen dueño y origen',
    created.length === 1 && /changelog/.test(created[0].text) && /Ninfa/.test(created[0].text)
      && created[0].live === 1,
