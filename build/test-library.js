...
check('lee los participantes', m.participants, ['Ninfa', 'Chuck']);
...
check('con su responsable', m.items.map(i => i.owner), ['Ninfa', 'Chuck']);
...
fs.writeFileSync(path.join(MEETINGS, '2026-07-30_0900', 'notes.md'),
  '## Action items\n- Ninfa: prepare the rollout plan\n- Chuck: review the deck\n- Send the contract\n', 'utf8');
({ meetings, changed } = lib.refresh({ meetingsDir: MEETINGS, indexFile: INDEX }));
